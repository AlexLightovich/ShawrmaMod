...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> VERTEL = registerBlock("vertel_block", () -> new VertelBlock(BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).noCollission()));
